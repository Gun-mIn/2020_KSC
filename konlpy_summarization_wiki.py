...
store = [] # keywords[0], keysentences[1], keyword of heyperlink[2], url of hyperlink[3], origin title[4], origin text[5]
...
def get_info_from_wiki(origin_url):
    ...
    #print("before every pre processing")
    #print(text)
    ...
    ##### print origin title and text #####
    #print("----- origin title -----")
    #print(origin_title)
    #print("----- origin text -----")
    #print(origin_text_result)
